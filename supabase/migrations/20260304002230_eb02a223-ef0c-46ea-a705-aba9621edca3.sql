...
BEGIN
  ...
  -- =============================================
  -- 2. FINANCIAL CATEGORIES (smart icons & colors)
  -- =============================================

  -- EXPENSE: Matéria-prima (red)
  ...
  -- EXPENSE: Despesas Administrativas (amber)
  INSERT INTO finance_categories (user_id, name, type, icon, color, is_system, sort_order, unit_id)
  ...
  -- EXPENSE: Folha de Pagamento (blue)
  INSERT INTO finance_categories (user_id, name, type, icon, color, is_system, sort_order, unit_id)
  ...
  -- INCOME: Vendas Delivery (emerald)
  INSERT INTO finance_categories (user_id, name, type, icon, color, is_system, sort_order, unit_id)
