    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-6">
          ...
          <div className="space-y-2"><Label htmlFor="phone" className="flex items-center gap-1.5"><AppIcon name="chat" size={14} fill={1} className="text-[#25D366]" />WhatsApp</Label><Input id="phone" {...register('phone')} placeholder="(11) 99999-9999" type="tel" /></div>
