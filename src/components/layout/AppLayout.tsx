    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header
        ...
        style={{
          ...
          background: 'linear-gradient(145deg, hsl(var(--primary) / 0.08) 0%, hsl(var(--primary) / 0.15) 50%, hsl(var(--primary) / 0.08) 100%), hsl(var(--background))',
        }}
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(145deg, hsl(var(--primary) / 0.06) 0%, hsl(var(--primary) / 0.12) 50%, hsl(var(--primary) / 0.06) 100%), hsl(var(--background) / 0.92)',
          }}
        >
      ...
      {/* ======= Desktop Sidebar ======= */}
      <aside className="hidden lg:flex fixed top-0 left-0 bottom-0 w-[260px] z-50 flex-col bg-card/60 backdrop-blur-3xl" style={{ borderRight: '1px solid hsl(var(--primary) / 0.1)' }}>
        {/* Premium brand header */}
        <div
          className="relative overflow-hidden shrink-0"
          style={{
            borderBottom: '1px solid hsl(var(--primary) / 0.1)',
            background: 'linear-gradient(145deg, hsl(var(--primary) / 0.06) 0%, hsl(var(--primary) / 0.12) 50%, hsl(var(--primary) / 0.06) 100%), hsl(var(--background) / 0.7)',
          }}
        >
          <div className="flex items-center gap-3 px-4 h-16 relative z-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-primary/50 font-medium tracking-wide">Gestão Inteligente</p>
            </div>
          </div>
        </div>
        ...
        <button
          onClick={() => navigate('/profile/me')}
          className="flex items-center gap-3 px-4 py-3 hover:bg-primary/5 transition-colors" style={{ borderBottom: '1px solid hsl(var(--primary) / 0.1)' }}
        >
        ...
        {/* Bottom actions */}
        <div className="px-3 py-3 space-y-1 shrink-0" style={{ borderTop: '1px solid hsl(var(--primary) / 0.1)' }}>
