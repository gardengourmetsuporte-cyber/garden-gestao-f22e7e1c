    ...
    return (
      <>
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetContent side="top" className="px-4 pb-6 pt-4 max-h-[70vh] overflow-y-auto rounded-b-2xl">
            <div className="text-sm font-semibold text-foreground mb-3">Notificações</div>
