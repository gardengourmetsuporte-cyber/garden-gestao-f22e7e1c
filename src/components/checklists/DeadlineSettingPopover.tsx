...
export function DeadlineSettingPopover({ type, currentSetting, onSave, isSaving }: Props) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className={cn("space-y-4 transition-opacity", !isActive && "opacity-40 pointer-events-none")}>
