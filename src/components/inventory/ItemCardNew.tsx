...
export function ItemCard({ item, onClick, onEdit }: ItemCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="card-surface p-3.5 cursor-pointer hover:shadow-[0_0_20px_hsl(68_100%_50%/0.05)] hover:border-white/10 active:scale-[0.98] transition-all duration-300 relative overflow-hidden group"
    >
