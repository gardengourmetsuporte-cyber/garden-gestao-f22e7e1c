...
const TOUR_STEPS: TourStep[] = [
  {
    title: 'Dashboard',
    description: 'Visão geral do seu negócio: saldo, vendas, checklists e ranking.',
    icon: 'LayoutDashboard',
    route: '/',
  },
  {
    title: 'Financeiro',
    description: 'Controle receitas, despesas, contas bancárias e fluxo de caixa.',
    icon: 'DollarSign',
    route: '/finance',
  },
  {
    title: 'Estoque',
    description: 'Gerencie itens, faça lançamentos e receba alertas de estoque baixo.',
    icon: 'Package',
    route: '/inventory',
  },
  {
    title: 'Checklists',
    description: 'Tarefas de abertura e fechamento para manter a operação em dia.',
    icon: 'CheckCircle',
    route: '/checklists',
  },
  {
    title: 'Equipe',
    description: 'Cadastre funcionários, controle pagamentos, escalas e pontuação.',
    icon: 'Users',
    route: '/employees',
  },
  {
    title: 'Cardápio Digital',
    description: 'Configure seu cardápio, QR codes das mesas e receba pedidos.',
    icon: 'UtensilsCrossed',
    route: '/cardapio',
  },
  {
    title: 'Configurações',
    description: 'Personalize categorias, métodos de pagamento, convites e mais.',
    icon: 'Settings',
    route: '/settings',
  },
];
      ...
      <div className="w-full max-w-md mx-4 mb-4 sm:mb-0 bg-card rounded-2xl shadow-2xl border border-border/50 overflow-hidden">
        ...
        <div className="p-6 text-center space-y-4">
          ...
          <div className="flex gap-2">
            <Button variant="ghost" onClick={handleFinish} className="flex-1 text-xs">
              Pular tour
            </Button>
            ...
            <Button onClick={handleNext} className="flex-1 text-xs">
