  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="flex items-center gap-3 p-4 rounded-2xl bg-card/60" style={{ animationDelay: `${i * 60}ms` }}>
  ...
  return (
    <div className={`grid gap-3`} style={{ gridTemplateColumns: `repeat(${cols}, minmax(0, 1fr))` }}>
      {Array.from({ length: rows * cols }).map((_, i) => (
        <div key={i} className="rounded-2xl bg-card/60 p-4 space-y-3" style={{ animationDelay: `${i * 60}ms` }}>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-2xl bg-card/60 p-4 space-y-2">
...
function DetailSkeleton() {
  return (
    <div className="space-y-4">
      <div className="rounded-2xl bg-card/60 p-6 space-y-3">
