...
export const CustomerCard = forwardRef<HTMLDivElement, Props>(function CustomerCard({ customer, onEdit, onDelete }, ref) {
  ...
  return (
    <div
      ref={ref}
      className="rounded-xl border border-border/60 bg-card p-4 space-y-3 hover:border-primary/25 active:scale-[0.98] transition-all duration-200 cursor-pointer"
      onClick={onEdit}
    >
      {/* Header */}
