  ...
  return (
    ...
    >
      ...
      <div className="pl-5 pr-4 py-3.5 space-y-2.5">
        ...
        {/* Bottom stats */}
        {((customer.loyalty_points > 0) || (Number(customer.total_orders) || 0) > 0 || (Number(customer.total_spent) || 0) > 0 || daysSince !== null) && (
          <div className="flex items-center gap-3 text-[11px] text-muted-foreground flex-wrap">
            {customer.loyalty_points > 0 && (
              <span className="flex items-center gap-1">
                <span className="material-symbols-rounded text-warning" style={{ fontSize: 13 }}>star</span>
