      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        >
          <div className={cn(
            ...
            <div className="w-full h-full rounded-full overflow-hidden bg-card dark:bg-foreground border border-border/30 dark:border-0 flex items-center justify-center">
