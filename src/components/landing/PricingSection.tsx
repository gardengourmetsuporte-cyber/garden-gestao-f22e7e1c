...
export function PricingSection() {
  ...
  return (
    <section id="planos" className="py-24 md:py-32 relative bg-[#000000] overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center gap-4 mb-16">
          ...
          <span className={`text-sm font-semibold transition-colors flex items-center ${yearly ? "text-white" : "text-white/40"}`}>
            Anual{" "}
            <span className="inline-flex ml-2 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
              -20%
            </span>
          </span>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto items-center">
          {plans.map((plan) => (
            ...
            >
              ...
              {plan.highlight ? (
                <>
                  <div className="absolute inset-0 bg-gradient-to-b from-emerald-400 to-emerald-900 rounded-3xl opacity-50 blur-md group-hover:opacity-70 transition-opacity duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-b from-emerald-400/50 to-transparent rounded-3xl" />
                </>
              ) : (
