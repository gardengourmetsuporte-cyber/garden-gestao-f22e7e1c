...
export function ProblemSection() {
  return (
    <section className="py-24 md:py-32 relative bg-background overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-destructive/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-foreground leading-[1.15] font-display tracking-tight">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {problems.map((p, i) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-border/60 to-border/20 opacity-100 group-hover:opacity-0 transition-opacity duration-500" />
              ...
              <div className="relative h-full rounded-[23px] bg-card border border-border/30 flex flex-col p-8 z-10">
                <div className="mb-6 relative">
                  ...
                  <div className="relative w-14 h-14 rounded-2xl bg-secondary/50 border border-border flex items-center justify-center shadow-inner">
