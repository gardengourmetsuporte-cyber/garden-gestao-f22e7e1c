  ...
  return createPortal(
    <>
      ...
      >
        ...
        <div className="mx-3 mb-3 rounded-[26px] p-[1px] nav-bar-neon-glow">
          {/* Inner bar */}
          <div
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: variant === 'personal'
                      ? '0 0 20px hsl(160 60% 45% / 0.5), 0 4px 16px hsl(0 0% 0% / 0.4)'
                      : '0 0 20px hsl(var(--primary) / 0.5), 0 0 40px hsl(262 80% 55% / 0.3), 0 4px 16px hsl(0 0% 0% / 0.4)',
                  }}
                >
