import { ArrowUpCircle, ArrowDownCircle, AlertCircle, Plus, ArrowLeftRight, CreditCard } from 'lucide-react';
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Button
          variant="outline"
          className="flex-col h-auto py-3 gap-1 bg-purple-500/10 border-purple-500/30 hover:bg-purple-500/20"
          onClick={() => onAddTransaction('credit_card')}
        >
