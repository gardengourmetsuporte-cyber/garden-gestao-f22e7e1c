  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center overflow-hidden bg-[#000000]">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-12 max-w-lg">
        {/* Logo */}
        <div
          className="relative w-40 h-40 rounded-[2rem] overflow-hidden flex items-center justify-center"
          style={{
            background: 'white',
            boxShadow: '0 0 100px hsl(142 71% 45% / 0.2), 0 25px 70px rgba(0,0,0,0.8)',
          }}
        >
          <img alt="Garden Gestão" className="w-[90%] h-[90%] object-contain" src={gardenLogo} />
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 pt-16 pb-12">
        ...
        <div
          className="w-28 h-28 rounded-[1.25rem] overflow-hidden flex items-center justify-center animate-[scale-in_0.6s_cubic-bezier(0.16,1,0.3,1)_0.1s_both]"
          style={{
            background: 'white',
