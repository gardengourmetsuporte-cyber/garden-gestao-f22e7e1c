...
const allMenuItems: MenuItem[] = [
  ...
  { value: 'plan', icon: 'Diamond', label: 'Meu Plano', description: 'Gerencie sua assinatura', variant: 'cyan', section: 'Conta', requiredPlan: 'free' },
  ...
  { value: 'checklists', icon: 'ClipboardCheck', label: 'Checklists', description: 'Gerenciar setores e itens de checklist', variant: 'amber', section: 'Operação', requiredPlan: 'free' },
