...
import { CopilotFullChat } from '@/components/copilot/CopilotFullChat';

const TABS = [
  { key: 'chat', label: 'Chat', icon: <AppIcon name="Chat" className="w-3 h-3" />, iconGradient: 'linear-gradient(135deg, #10b981, #059669)' },
...
export default function Copilot() {
  ...
  return (
    <AppLayout>
      <div className={isChat ? "h-screen flex flex-col" : "min-h-screen pb-36 lg:pb-12"}>
        <div className={`px-4 py-4 max-w-3xl mx-auto ${isChat ? 'flex flex-col flex-1 overflow-hidden' : 'space-y-4'}`}>
          {/* Header */}
          {!isChat && (
