...
export const CUSTOM_SVG_PATHS: Record<string, string[]> = {
  ...
  Receipt: [
    'M4,21V7A2,2,0,0,1,6,5H18a2,2,0,0,1,2,2V21a1,1,0,0,1-1.5.87L15,19.5,11.5,21.37a1,1,0,0,1-.95,0L7,19.5,3.5,21.87A1,1,0,0,1,4,21ZM8,9a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Zm0,4a1,1,0,0,0,0,2h5a1,1,0,0,0,0-2Z',
  ],
  UserSearch: [
