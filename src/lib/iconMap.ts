...
export const CUSTOM_SVG_PATHS: Record<string, string[]> = {
  ChartPie: [
    'M11 2.05V12.97l7.7 4.45A10 10 0 0 1 11 22C5.48 22 1 17.52 1 12S5.48 2 11 2.05Z',
    'M13 2.05A10 10 0 0 1 22.95 11H13V2.05Z',
    'M13 13h9.95a10 10 0 0 1-3.64 6.36L13 15.42V13Z',
  ],
  Menu: [
