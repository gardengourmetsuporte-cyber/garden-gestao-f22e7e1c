// Custom SVG icon paths (inline data URIs for reliability)
const SVG_BALLOT_CHECK = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m17,0H7C4.243,0,2,2.243,2,5v14c0,2.757,2.243,5,5,5h10c2.757,0,5-2.243,5-5V5c0-2.757-2.243-5-5-5ZM7.5,4.5c.828,0,1.5.672,1.5,1.5s-.672,1.5-1.5,1.5-1.5-.672-1.5-1.5.672-1.5,1.5-1.5Zm0,15c-.828,0-1.5-.672-1.5-1.5s.672-1.5,1.5-1.5,1.5.672,1.5,1.5-.672,1.5-1.5,1.5Zm1.365-5.979c-.319.319-.741.479-1.165.479-.427,0-.855-.162-1.182-.487l-.681-.655c-.398-.382-.411-1.016-.028-1.414.383-.399,1.017-.41,1.414-.028l.472.454,1.866-1.815c.396-.385,1.029-.377,1.414.02.385.396.376,1.029-.02,1.414l-2.091,2.034Zm8.135,5.479h-5c-.552,0-1-.448-1-1s.448-1,1-1h5c.552,0,1,.448,1,1s-.448,1-1,1Zm0-6h-3c-.552,0-1-.448-1-1s.448-1,1-1h3c.552,0,1,.448,1,1s-.448,1-1,1Zm0-6h-5c-.552,0-1-.448-1-1s.448-1,1-1h5c.552,0,1,.448,1,1s-.448,1-1,1Z"/></svg>')}`;

const SVG_BOXES = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m17.449 3.265c-.102-.324-.362-.575-.69-.664-.09-.024-2.233-.601-4.759-.601s-4.668.577-4.758.601c-.329.089-.59.341-.692.667-.026.083-.629 2.047-.629 4.649 0 .146.002.291.006.433.348-.019.707-.031 1.074-.031 1.986 0 4.053.339 5.044.527 1.059-.204 3.038-.527 4.956-.527.367 0 .726.011 1.074.031.004-.142.006-.286.006-.432 0-2.625-.604-4.571-.63-4.652zm-4.449 3.235h-2c-.552 0-1-.448-1-1s.448-1 1-1h2c.552 0 1 .448 1 1s-.448 1-1 1z"/><path d="m7 10.319c-2.482 0-4.598.567-4.687.592-.33.089-.591.341-.692.667-.025.081-.621 2.018-.621 4.582 0 2.586.596 4.504.622 4.584.103.325.362.575.69.664.089.024 2.2.592 4.688.592 1.457 0 2.981-.189 4-.346v-10.962c-1.021-.17-2.542-.372-4-.372zm.5 5.181h-2.5c-.552 0-1-.448-1-1s.448-1 1-1h2.5c.552 0 1 .448 1 1s-.448 1-1 1z"/><path d="m22.378 11.575c-.103-.325-.362-.575-.69-.664-.089-.024-2.2-.592-4.688-.592-1.456 0-2.977.209-4 .386v10.962c1.017.151 2.54.333 4 .333 2.482 0 4.598-.567 4.687-.592.33-.089.591-.341.692-.667.025-.081.621-2.018.621-4.582 0-2.586-.596-4.504-.622-4.584zm-3.378 3.925h-2.5c-.552 0-1-.448-1-1s.448-1 1-1h2.5c.552 0 1 .448 1 1s-.448 1-1 1z"/></svg>')}`;

const SVG_DEBT = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m23.949,18.293l-1.284-9c-.35-2.447-2.478-4.293-4.95-4.293h-2.566c.219-.456.351-.961.351-1.5,0-1.93-1.57-3.5-3.5-3.5s-3.5,1.57-3.5,3.5c0,.539.133,1.044.351,1.5h-2.491c-2.493,0-4.572,1.789-4.944,4.254L.057,18.254c-.218,1.441.202,2.901,1.153,4.007.951,1.105,2.333,1.739,3.791,1.739h13.998c1.45,0,2.827-.628,3.777-1.724.95-1.095,1.377-2.547,1.173-3.983ZM12,2c.827,0,1.5.673,1.5,1.5s-.673,1.5-1.5,1.5-1.5-.673-1.5-1.5.673-1.5,1.5-1.5Zm1,18v1c0,.553-.448,1-1,1s-1-.447-1-1v-1h-.268c-1.067,0-2.063-.574-2.598-1.499-.276-.479-.113-1.09.365-1.366.477-.278,1.089-.114,1.366.364.179.31.511.501.867.501h2.268c.552,0,1-.448,1-1,0-.379-.271-.698-.645-.761l-3.04-.506c-1.342-.224-2.315-1.374-2.315-2.733,0-1.654,1.346-3,3-3v-1c0-.553.448-1,1-1s1,.447,1,1v1h.268c1.067,0,2.063.574,2.598,1.499.277.479.113,1.09-.364,1.366-.48.278-1.092.112-1.366-.364-.179-.31-.511-.501-.867-.501h-2.268c-.551,0-1,.448-1,1,0,.379.271.698.644.761l3.041.506c1.342.224,2.315,1.374,2.315,2.733,0,1.654-1.346,3-3,3Z"/></svg>')}`;

const SVG_HOUSE = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,24H5c-2.757,0-5-2.243-5-5V9.724c0-1.665,.824-3.215,2.204-4.145L9.203,.855c1.699-1.146,3.895-1.146,5.594,0l7,4.724c1.379,.93,2.203,2.479,2.203,4.145v9.276c0,2.757-2.243,5-5,5Z"/></svg>')}`;

export const CUSTOM_SVG_ICONS: Record<string, string> = {
  ClipboardCheck: SVG_BALLOT_CHECK,
  ClipboardList: SVG_BALLOT_CHECK,
  ListChecks: SVG_BALLOT_CHECK,
  Package: SVG_BOXES,
  PackageX: SVG_BOXES,
  PackageCheck: SVG_BOXES,
  DollarSign: SVG_DEBT,
  Wallet: SVG_DEBT,
  Coins: SVG_DEBT,
  Home: SVG_HOUSE,
