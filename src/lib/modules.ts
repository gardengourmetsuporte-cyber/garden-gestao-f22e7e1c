...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { key: 'recipes', label: 'Fichas Técnicas', icon: 'ChefHat', route: '/recipes', routes: ['/recipes'], group: 'Em Produção' },
  ...
  { key: 'gamification', label: 'Gamificação', icon: 'Dices', route: '/gamification', routes: ['/gamification'], group: 'Em Produção' },
