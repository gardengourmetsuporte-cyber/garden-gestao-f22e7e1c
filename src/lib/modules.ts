...
export const ALL_MODULES: ModuleDef[] = [
  ...
  {
    key: 'marketing', label: 'Marketing', icon: 'Megaphone', route: '/marketing', routes: ['/marketing'], group: 'Gestão',
    children: [
      ...
      { key: 'marketing.brand_core', label: 'Marca / Brand', icon: 'Palette' },
    ],
  },
  {
  ...
  {
    key: 'menu-admin', label: 'Cardápio', icon: 'RecipeBook', route: '/cardapio', routes: ['/cardapio', '/menu-admin', '/tablet-admin', '/gamification'], group: 'Operação',
    children: [
  ...
  {
    key: 'whatsapp', label: 'WhatsApp IA', icon: 'MessageSquare', route: '/whatsapp', routes: ['/whatsapp', '/whatsapp/chats', '/whatsapp/orders', '/whatsapp/knowledge', '/whatsapp/logs', '/whatsapp/settings'], group: 'Operação',
    children: [
