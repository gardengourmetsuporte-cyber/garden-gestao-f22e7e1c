...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { key: 'marketing', label: 'Marketing', icon: 'Megaphone', route: '/marketing', routes: ['/marketing'], group: 'Produção' },
  ...
  { key: 'menu-admin', label: 'Cardápio', icon: 'BookOpen', route: '/cardapio', routes: ['/cardapio'], group: 'Produção' },
  { key: 'whatsapp', label: 'WhatsApp', icon: 'MessageSquare', route: '/whatsapp', routes: ['/whatsapp'], group: 'Produção' },
  ...
  { key: 'tablet-admin', label: 'Tablets', icon: 'Monitor', route: '/tablet-admin', routes: ['/tablet-admin'], group: 'Produção' },
